...
<?php
  ...
  if(isset($_POST['save'])){
    ...
    if($_POST['destination1'] != null || !empty($_POST['destination1']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination1']));

    if($_POST['destination2'] != null || !empty($_POST['destination2']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination2']));

    if($_POST['destination3'] != null || !empty($_POST['destination3']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination3']));

    if($_POST['destination4'] != null || !empty($_POST['destination4']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination4']));

    if($_POST['destination5'] != null || !empty($_POST['destination5']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination5']));

    if($_POST['destination6'] != null || !empty($_POST['destination6']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination6']));

    if($_POST['destination7'] != null || !empty($_POST['destination7']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination7']));

    if($_POST['destination8'] != null || !empty($_POST['destination8']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination8']));

    if($_POST['destination9'] != null || !empty($_POST['destination9']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination9']));

    if($_POST['destination10'] != null || !empty($_POST['destination10']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination10']));

    if($_POST['destination11'] != null || !empty($_POST['destination11']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination11']));

    if($_POST['destination12'] != null || !empty($_POST['destination12']))
      array_push($destinations, mysqli_real_escape_string($con, $_POST['destination12']));
                  ...
                  <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                    ...
                    <div style="position:absolute; top:0px; right: 0px; color: white; font-weight:bold; background-color: rgb(0, 123, 255); padding: 10px 5px;">
                      ...
                      <span class="sub-title mb-2 d-block">
                        ...
                        <a target="_blank" href="tour_package_modify.php?id=<?php echo $row['id']; ?>">
    ...
    <div style="width: 50%; margin:auto;">  
        <div class="service h-100">
            ...
            <form style="padding: 10px; margin-top:8px;" method="POST" autocomplete="off">
                ...
                <br> <br>
                <input type="submit" value="Save" name="save" class="btn btn-primary" style="border-radius:0px;"/> 
                | 
                <button type="button" onclick="$('.add_new_package').css('display', 'none');" class="btn btn-light" style="border-radius:0px;">Cancel</button>
            </form>
