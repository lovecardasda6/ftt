...
/***********************************************/
    if($_POST['destination1'] != null || !empty($_POST['destination1'])){
        $destination1 = mysqli_real_escape_string($con, $_POST['destination1']);
...
/***********************************************/
    if($_POST['destination2'] != null || !empty($_POST['destination2'])){
        $destination2 = mysqli_real_escape_string($con, $_POST['destination2']);
...
/***********************************************/
    if($_POST['destination3'] != null || !empty($_POST['destination3'])){
        $destination3 = mysqli_real_escape_string($con, $_POST['destination3']);

        if($_POST['id3'] != null || !empty($_POST['id3'])){
            $id3 = mysqli_real_escape_string($con, $_POST['id3']);
...
/***********************************************/
    if($_POST['destination4'] != null || !empty($_POST['destination4'])){
        $destination4 = mysqli_real_escape_string($con, $_POST['destination4']);

        if($_POST['id4'] != null || !empty($_POST['id4'])){
            $id4 = mysqli_real_escape_string($con, $_POST['id4']);
...
/***********************************************/
    if($_POST['destination5'] != null || !empty($_POST['destination5'])){
        $destination5 = mysqli_real_escape_string($con, $_POST['destination5']);

        if($_POST['id5'] != null || !empty($_POST['id5'])){
            $id5 = mysqli_real_escape_string($con, $_POST['id5']);
...
/***********************************************/
    if($_POST['destination6'] != null || !empty($_POST['destination6'])){
        $destination6 = mysqli_real_escape_string($con, $_POST['destination6']);

        if($_POST['id6'] != null || !empty($_POST['id6'])){
            $id6 = mysqli_real_escape_string($con, $_POST['id6']);
...
/***********************************************/
    if($_POST['destination7'] != null || !empty($_POST['destination7'])){
        $destination7 = mysqli_real_escape_string($con, $_POST['destination7']);

        if($_POST['id7'] != null || !empty($_POST['id7'])){
            $id7 = mysqli_real_escape_string($con, $_POST['id7']);
...
/***********************************************/
    if($_POST['destination8'] != null || !empty($_POST['destination8'])){
        $destination8 = mysqli_real_escape_string($con, $_POST['destination8']);

        if($_POST['id8'] != null || !empty($_POST['id8'])){
            $id8 = mysqli_real_escape_string($con, $_POST['id8']);
...
/***********************************************/
    if($_POST['destination9'] != null || !empty($_POST['destination9'])){
        $destination9 = mysqli_real_escape_string($con, $_POST['destination9']);

        if($_POST['id9'] != null || !empty($_POST['id9'])){
            $id9 = mysqli_real_escape_string($con, $_POST['id9']);
...
/***********************************************/
    if($_POST['destination10'] != null || !empty($_POST['destination10'])){
        $destination10 = mysqli_real_escape_string($con, $_POST['destination10']);

        if($_POST['id10'] != null || !empty($_POST['id10'])){
            $id10 = mysqli_real_escape_string($con, $_POST['id10']);
...
/***********************************************/
    if($_POST['destination11'] != null || !empty($_POST['destination11'])){
        $destination11 = mysqli_real_escape_string($con, $_POST['destination11']);

        if($_POST['id11'] != null || !empty($_POST['id11'])){
            $id11 = mysqli_real_escape_string($con, $_POST['id11']);
...
/***********************************************/
    if($_POST['destination12'] != null || !empty($_POST['destination12'])){
        $destination12 = mysqli_real_escape_string($con, $_POST['destination12']);

        if($_POST['id12'] != null || !empty($_POST['id12'])){
            $id12 = mysqli_real_escape_string($con, $_POST['id12']);
