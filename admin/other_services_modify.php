...
<?php
  ...
  if(isset($_POST['save'])){
    ...
    if($image_name != null || !empty($image_name)){
        ...
        $update_query = "UPDATE `other_services` SET `service_name`='".$service_name."', `description`='".$description."', `image` = '".$image."' WHERE id = ".$id;
        ...
        $update_query = "UPDATE `other_services` SET `service_name`='".$service_name."', `description`='".$description."' WHERE id = ".$id;
        ...
        <div class="container">
            ...
            <div style="width: 50%; margin:auto;">  
                <div class="service h-100">
                    ...
                    <Br>
                        <?php
                            $q = "SElECT * FROM other_services WHERE id = ".$id;
                            ...
                            ?>
                                    ...
                                    <form style="padding: 10px; margin-top:8px;" method="POST" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <br><br>
                                        <input type="text" require name="service_name" value="<?php echo $row['service_name']; ?>" placeholder="Service Name" style="width: 100%; padding-left: 10px; font-size: 18px; margin-bottom:15px;" /> 
