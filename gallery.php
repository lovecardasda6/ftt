                    ...
                    <div class="row align-items-center">
                        ...
                        <nav class="site-navigation text-right" role="navigation">
                            ...
                            <ul class="site-menu main-menu js-clone-nav d-none d-lg-none">
                                ...
                                <li><a href="index.php" class="nav-link">Update</a></li>
                                <!-- <li><a href="#about-us-section" class="nav-link">About Us</a></li> -->
                                
                                <li><a href="index.php" class="nav-link">Services</a></li>
                                
                                <li><a href="index.php" class="nav-link">Tour Package</a></li>
                                <!-- <li><a href="#what-we-do-section" class="nav-link">What We Do</a></li> -->
                                <li><a href="index.php" class="nav-link">New Destinations</a></li>
                                <!-- <li><a href="#portfolio-section" class="nav-link">Portfolio</a></li> -->
                                <li><a href="gallery.php" class="nav-link">Gallery</a></li>
                                <li><a href="#contact-section" class="nav-link">Contact</a></li>
                                <li><a href="other_services.php" class="nav-link">Other Services</a></li>
                            </ul>
                            </div>
                        </nav>
                        </div>
