...
(1, 'Airlines', 'AirAsia', ' a low-cost airline based at Kuala Lumpur International Airport, Malaysia. The airline has partnered with other airlines and investors to create ventures in the Philippines, India and Japan.', '26122019135953AirAsia.png', 'ACTIVE'),
(2, 'Airlines', 'Cebu Pacific', ' a flag carrier of the Philippines. The airline was founded in 1941 and is the first and oldest commercial airline in Asia. It serves 31 destinations in the Philippines and 41 overseas destinations.', '26122019140005cebupacific.png', 'ACTIVE'),
(3, 'Airlines', 'Philippine Airliness', '         a Philippine low-cost airline based on the grounds of Ninoy Aquino International Airport (NAIA Terminal 3), Pasay City, Metro Manila, in the Philippines. It offers scheduled flights to both domestic and international destinations.', '2612201914580626122019140011Philippine-Airlines-Logo.jpg', 'ACTIVE'),
(4, 'Shippings', 'Ocean Fast Ferries Inc. Travel', 'which is formerly known as Ocean Jet, is a Filipino-owned shipping company that you can trust when you want to visit Cebu if you\'re from Visayas and Mindanao. Ocean Fast Ferries assures its passengers a safe and comfortable ride.', 'oceanjetlogo.png', 'ACTIVE'),
...
(6, 'Shippings', 'Cokaliong Shipping Lines, Inc. (CSLI)', 'a shipping line based in Cebu City, Philippines. A shipping line that operates both passenger and cargo ferries on eight routes between islands in the Visayas and Mindanao regions.', 'cokaliong.jpg', 'ACTIVE'),
(7, 'Shippings', 'Trans Asia Shipping Lines, Incorporated (TA SLI)', 'a shipping company based in Cebu City, Philippines. It offers services such as passenger and cargo transportation.', 'trans.png', ''),
(8, 'Shippings', '2GO Travel', ' a passenger ferry company which is based in Manila, Philippines and part of 2GO Group. It is the largest ferry company in the Philippines with its main hub located in Eva Macapagal Super Terminal in Pier 15 in the Manila South Harbor.', '261220191457462GO-Travel-Transparent-Reversal-1.png', 'ACTIVE');
...
(3, 'Panglao Island Tours', '', ''),
(4, 'Bohol Countryside Tour', '', 'ACTIVE'),
(5, 'Island Hopping Tour', '', 'ACTIVE'),
(6, 'CHAP Tour', '', 'ACTIVE'),
(7, 'E.A.T Danao', '', 'ACTIVE'),
(8, 'Firefly Watching', '', 'ACTIVE');
