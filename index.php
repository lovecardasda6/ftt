        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 ml-auto section-title">
              <span class="sub-title mb-2 d-block">Update</span>
          ...
          <div class="col-lg-5 ml-auto section-title">
            ...
            <div class="d-flex">
              <ul class="list-unstyled ul-check success mr-5">
                <li> <b style="text-decoration: underline;">AirAsia</b>
                  <p class="mb-4">a low-cost airline based at Kuala Lumpur International Airport, Malaysia. The airline has partnered with other airlines and investors to create ventures in the Philippines, India and Japan.</p>

                </li>
                
                <li> <b style="text-decoration: underline;">Cebu Pacific</b>
                  <p class="mb-4">a flag carrier of the Philippines. The airline was founded in 1941 and is the first and oldest commercial airline in Asia. It serves 31 destinations in the Philippines and 41 overseas destinations.</p>
                </li>
                <li>
                  <b style="text-decoration: underline;">Philippine Airlines</b>
                  <p class="mb-4"> a Philippine low-cost airline based on the grounds of Ninoy Aquino International Airport (NAIA Terminal 3), Pasay City, Metro Manila, in the Philippines. It offers scheduled flights to both domestic and international destinations.</p>
                </li>
              </ul>
            </div>  
          </div>
...
<!---------------------------------------------------------------------------------------------->
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5">
            <div class="owl-carousel slide-one-item hero-slider">
                <div class="slide overlay">
                  ...
                  <div class="slide overlay">
                      <img src="images/trans.png" alt="Image" class="img-fluid">  
                    </div>
              <div class="slide overlay">
                <img src="images/2GO-Travel-Transparent-Reversal-1.png" alt="Image" class="img-fluid">  
              </div>
              
              <div class="slide overlay">
                <img src="images/oceanjetlogo.png" alt="Image" class="img-fluid">  
              </div>
              <div class="slide overlay">
                <img src="images/scat.png" alt="Image" class="img-fluid">  
              </div>
          ...
          <div class="col-lg-5 ml-auto section-title">
            ...
            <div class="d-flex">
              <ul class="list-unstyled ul-check success mr-5">
                <li><b style="text-decoration: underline;">Cokaliong Shipping Lines, Inc. (CSLI)</b>
                  <p class="mb-4">a shipping line based in Cebu City, Philippines. A shipping line that operates both passenger and cargo ferries on eight routes between islands in the Visayas and Mindanao regions.


                  </p>
                </li>
                <li><b style="text-decoration: underline;">Trans Asia Shipping Lines, Incorporated (TA SLI)</b>
                  <p class="mb-4">a shipping company based in Cebu City, Philippines. It offers services such as passenger and cargo transportation.</p>
                </li>
                <li><b style="text-decoration: underline;">2GO Travel</b>
                  <p class="mb-4">a passenger ferry company which is based in Manila, Philippines and part of 2GO Group. It is the largest ferry company in the Philippines with its main hub located in Eva Macapagal Super Terminal in Pier 15 in the Manila South Harbor.</p>
                </li>
                <li><b style="text-decoration: underline;">Ocean Fast Ferries Inc. Travel</b>
                  <p class="mb-4">which is formerly known as Ocean Jet, is a Filipino-owned shipping company that you can trust when you want to visit Cebu if you’re from Visayas and Mindanao. Ocean Fast Ferries assures its passengers a safe and comfortable ride.</p>
                </li>
                <li><b style="text-decoration: underline;">Supercar Fast Ferry Corporation</b>
                  <p class="mb-4">commonly known as SuperCat, was a shipping company that operated a fleet of High Speed Catamarans in the Philippines. It is now part of 2GO Travel. Supercat was the sister company of SuperFerry and Cebu Ferries. It operated 7 vessels in 7 ports around the Philippines.</p>
                </li>
              </ul>
            </div>
            <!-- <p><a data-fancybox data-ratio="2" href="https://vimeo.com/326176805" class="d-flex align-items-center"><span class="icon-play_circle_outline h4 m-0 mr-2"></span> <span>Watch the video</span></a></p> -->
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                <div class="service h-100">
                  ...
                  <h3>Panglao Island Tours</h3>
                  <li>Bohol Dream Land</li>
                      <li>Dauis Church</li>
              ...
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                <div class="service h-100">
                  ...
                  <li>Blood Compact Shrine</li>
                      ...
                      <li>Tarsier Conservation Park</li>
                      <li>Loboc River & Floating Restaurant</li>
                      <li>Bilar Man Made Forest</li>
                      <li>Simply Butterflies</li>
              ...
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                <div class="service h-100">
                  <span class="icon-map-marker display-4 text-primary d-block mb-4"></span>
                  <h3>CHAP Tour</h3>
                  <li>Chocolate Hills Adventure Park (CHAP) is Bohol's latest eco-tourism adventure park. CHAP offers thrilling adventure activities for adults and children. This includes the Rush Bike Zip , Wave Runner Surf Zipline, Eco-nature hiking, Mountain Biking, Horse-back Riding Trails, and many more.</li>
                      <br>
                  <p><a href="#" class="readmore">Learn more</a></p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                <div class="service h-100">
                  <span class="icon-map-marker display-4 text-primary d-block mb-4"></span>
                  <h3>E.A.T Danao</h3>
                      <li>E.A.T. Danao is a tourism concept set up to benefit the municipality of Danao and its people. The specific activities were grouped into three: Extreme, Economic, and Educational. So “E” stands for any of the three; “A” for Adventure; then “T” for Tour.</li>
                      <br>
                  <p><a href="#" class="readmore">Learn more</a></p>
                </div>
              </div>
